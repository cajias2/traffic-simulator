...
public class StupidModel extends SimState {
	...
	public StupidModel(long seed) {
		super(new MersenneTwisterFast(seed), new Schedule(7));
	}
	...
	public void buildModel() {
	  ...
	  predatorSpace = new ObjectGrid2D(xSpaceSize,ySpaceSize);
	  predators = new StupidPredator[initNumberOfPredators];

      for (int i=0; i<initNumberOfPredators; i++) {
		  predators[i] = new StupidPredator(this);
	  }
}
	...
	public void buildSchedule() {
		...
		schedule.scheduleRepeating(0,4,new Sequence(predators));
	...
	public int getInitNumberOfPredators() {
		return initNumberOfPredators;
	}

	public void setInitNumberOfPredators(int initNumberOfPredators) {
		this.initNumberOfPredators = initNumberOfPredators;
	}

	public ObjectGrid2D getPredatorSpace() {
		return predatorSpace;
	}

	public void setPredatorSpace(ObjectGrid2D predatorSpace) {
		this.predatorSpace = predatorSpace;
	}
}
