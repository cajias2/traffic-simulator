...
public class StupidModelWithUI extends GUIState {
	...
	public ObjectGridPortrayal2D predatorPortrayal;
    ...
    private void setupDisplay() {
	  ...
	  int ySpaceSize = y+1;
    	...
    	predatorPortrayal = new ObjectGridPortrayal2D() {
    		public Portrayal getDefaultPortrayal() {
    			return new OvalPortrayal2D(Color.red,1.0) {
    				   public void draw(Object object, Graphics2D graphics, DrawInfo2D info) {
    					   if (object instanceof StupidPredator) {
    						   paint = Color.blue;
							   super.draw(object, graphics, info);
    					   }
    				   }
    	...
    	display.attach(bugPortrayal,"Stupid bug portrayal");
    	display.attach(predatorPortrayal,"Stupid predator portrayal");
	...
	public void start() {
    	...
    	predatorPortrayal.setField(((StupidModel) state).getPredatorSpace());
