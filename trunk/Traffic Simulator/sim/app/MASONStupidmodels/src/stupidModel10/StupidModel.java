...
public class StupidModel extends SimState {
	...
	public void buildSchedule() {
		...
		// this sorts the bugs by size and then
		// moves them.
		Steppable bugMoveStep = new Steppable() {
			public void step (SimState state) {
				Arrays.sort(bugs,new Comparator() {
					public int compare(Object obj1, Object obj2) {
						StupidBug bug1 = (StupidBug) obj1;
						StupidBug bug2 = (StupidBug) obj2;
						if (bug1.getSize() < bug2.getSize()) return 1;
						if (bug1.getSize() == bug2.getSize()) return 0;
						return -1;
					}
