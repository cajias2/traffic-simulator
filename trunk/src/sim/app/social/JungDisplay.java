...
public class JungDisplay extends JComponent implements Steppable {
	 ...
	 */
	Graph socGraph = Agent.getSocGraph();
	DijkstraDistance distance = new DijkstraDistance(socGraph);
	layout = new KKLayout(socGraph, distance);

	/*
	 * Viewer is AWT Component subclass, doing the rendering, which can be
	 * directly added to a JPanel.
	 */
	viewer = new VisualizationViewer(layout, new Dimension(1000, 1000));
