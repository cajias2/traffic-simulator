...
public class TrafficSimUI extends GUIState {
    ...
    @Deprecated
    public TrafficSimUI() {
	super(new MasonSim(System.currentTimeMillis()));
    }

    public TrafficSimUI(MasonSim _sim) {
	super(_sim);
    }
	...
	_trafficSim = new MasonSim(System.currentTimeMillis(), cityXml, _log);
